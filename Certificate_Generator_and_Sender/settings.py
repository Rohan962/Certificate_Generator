...
# EMAIL_PORT = 587
# EMAIL_HOST_USER = 'rohankedari962@gmail.com'
# EMAIL_HOST_PASSWORD = 'cwqi mqma lnwu detn'
# EMAIL_USE_TLS = True

EMAIL_BACKEND = 'django_ses.SESBackend'
AWS_ACCESS_KEY_ID = os.getenv('AWS_ACCESS_KEY_ID')
AWS_SECRET_ACCESS_KEY = os.getenv('AWS_SECRET_ACCESS_KEY')
AWS_SES_REGION_NAME = 'us-east-1'  # Change this based on your AWS region
AWS_SES_REGION_ENDPOINT = 'email.us-east-1.amazonaws.com'
DEFAULT_FROM_EMAIL = 'support@embrizon.com'
EMAIL_HOST_USER = 'support@embrizon.com'
